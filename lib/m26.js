...
(function() {
  var M26, M26Distance, M26ElapsedTime, M26Speed, root,
  ...
  M26Distance = (function() {
    function M26Distance(d, uom) {
      var _ref;
      if (d == null) {
        d = 0;
      }
    ...
    M26Distance.prototype.uom = function() {
      return this.u;
    };

    M26Distance.prototype.dist = function() {
      return this.d;
    };
  ...
  M26ElapsedTime = (function() {
    function M26ElapsedTime(val) {
      var _ref;
      if (val == null) {
        val = '00:00:00';
      }
    ...
    M26ElapsedTime.prototype.initialize_from_string = function(s) {
      var error, tokens;
      try {
        tokens = s.split(':');
        if (tokens.length === 3) {
